      ...
      <div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 h-fit">
            <Card className="bg-white border-l-4 border-l-emerald-500 shadow-sm min-h-[160px]">
              <CardContent className="p-6 h-full flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-500">Income (Paid)</p>
            ...
            <Card className="bg-white border-l-4 border-l-rose-500 shadow-sm min-h-[160px]">
              <CardContent className="p-6 h-full flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Card className={`bg-white border-l-4 shadow-sm min-h-[160px] ${netCashFlow >= 0 ? 'border-l-sky-500' : 'border-l-amber-500'}`}>
              <CardContent className="p-6 h-full flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-500">Net Flow</p>
                    <h3 className={`text-2xl font-bold mt-1 ${netCashFlow >= 0 ? 'text-sky-700' : 'text-amber-700'}`}>
                      {netCashFlow >= 0 ? '+' : ''}{formatCurrency(netCashFlow)}
                    </h3>
                  </div>
                  <div className={`p-3 rounded-full ${netCashFlow >= 0 ? 'bg-sky-100 text-sky-600' : 'bg-amber-100 text-amber-600'}`}>
            ...
            <Card className="bg-white border-l-4 border-l-yellow-500 shadow-sm min-h-[160px]">
              <CardContent className="p-6 h-full flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <div>
