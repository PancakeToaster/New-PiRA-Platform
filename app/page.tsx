...
import { realActivities, realCourses, companyInfo } from '@/lib/realData';
...
export default function HomePage() {
  ...
  const featuredCourses = realCourses.slice(0, 3);
      ...
      >
        ...
        <section className="relative h-screen snap-center snap-always flex items-center justify-center z-10">
          <div className="relative z-20 max-w-4xl mx-auto px-6 text-center">
            <h1
              className={`text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-gray-900 transition-all duration-1000 ${
            ...
            <p
              className={`text-lg md:text-xl lg:text-2xl mb-8 text-gray-600 max-w-3xl mx-auto transition-all duration-1000 delay-200 ${
                hasLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
            >
              {companyInfo.mission}
        ...
        <section className="relative h-screen snap-end snap-always flex items-center justify-center z-10">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                <div className="aspect-video bg-gradient-to-br from-sky-400 to-sky-600 rounded-3xl shadow-2xl flex items-center justify-center text-white overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                <div className="aspect-video bg-gradient-to-br from-blue-500 to-blue-700 rounded-3xl shadow-2xl flex items-center justify-center text-white">
                  <div className="text-center p-8">
                    <div className="text-6xl lg:text-7xl mb-4">🏆</div>
                ...
                >
                  ...
                  <div className="p-5">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="text-xl font-bold text-sky-500">${course.price}</div>
                    </div>
                  ...
                  >
                    <div className="bg-gradient-to-r from-sky-500 to-sky-600 px-5 py-3">
                      <div className="flex items-center justify-between text-white">
                        <span className="font-bold text-sm uppercase">{activity.type}</span>
                        <span className="text-sm opacity-90">{activity.ageRange}</span>
                      </div>
                    </div>
                    <div className="p-5">
                      ...
                      <div className="text-sm text-gray-500 space-y-1">
                        <div>{activity.date.toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</div>
        ...
        {/* CTA Section */}
        <section className="relative h-screen snap-end snap-always flex items-center justify-center bg-gradient-to-br from-sky-500 to-sky-600 z-10">
          <div className="max-w-4xl mx-auto px-6 text-center text-white">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Ready to Start Your Journey?</h2>
            <p className="text-lg lg:text-xl mb-10 text-sky-100">
