                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="border-t pt-4">
                            ...
                            <div className="space-y-3">
                                ...
                                >
                                    <Lock className={`w-5 h-5 mt-0.5 ${!isPublic ? 'text-sky-600 dark:text-sky-400' : 'text-muted-foreground'}`} />
                                ...
                                >
                                    <Globe className={`w-5 h-5 mt-0.5 ${isPublic ? 'text-green-600 dark:text-green-400' : 'text-muted-foreground'}`} />
                                    <div className="text-left flex-1">
