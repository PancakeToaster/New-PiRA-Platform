...
export default async function TeacherProgressPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <p className="text-gray-600">Track student progress across your courses.</p>
                    ...
                    <Card key={course.id} className="hover:shadow-md transition-shadow">
                        ...
                        <CardContent>
                            ...
                            <Link href={`/admin/courses/${course.id}/grades`}>
                                <div className="w-full bg-sky-50 text-sky-700 py-2 rounded-md text-center text-sm font-medium hover:bg-sky-100 transition-colors">
