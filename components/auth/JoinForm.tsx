                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8">
                        {userType === 'student' ? (
                            <>
                                ...
                                <h2 className="text-2xl font-bold text-gray-900 mb-2">Approval Needed</h2>
                            ...
                            <>
                                ...
                                {formData.childUsername && (
                                    <div className="bg-sky-50 border border-sky-100 p-4 rounded-lg mb-6 text-left">
                                        <h4 className="font-bold text-sky-900 mb-1">Child Login Information</h4>
        ...
        <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white pt-24 pb-16 px-4">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex items-center justify-center mb-8">
                    <div className={`flex items-center justify-center w-10 h-10 rounded-full font-bold ${step >= 1 ? 'bg-sky-500 text-white' : 'bg-gray-200 text-gray-500'
                        }`}>
                        1
                    </div>
                    <div className={`w-16 h-1 ${step >= 2 ? 'bg-sky-500' : 'bg-gray-200'}`} />
                    <div className={`flex items-center justify-center w-10 h-10 rounded-full font-bold ${step >= 2 ? 'bg-sky-500 text-white' : 'bg-gray-200 text-gray-500'
                        }`}>
                        2
                    </div>
                    <div className={`w-16 h-1 ${step >= 3 ? 'bg-sky-500' : 'bg-gray-200'}`} />
                    <div className={`flex items-center justify-center w-10 h-10 rounded-full font-bold ${step >= 3 ? 'bg-sky-500 text-white' : 'bg-gray-200 text-gray-500'
                        }`}>
                        3
                    </div>
                </div>
                            ...
                            <div className="space-y-4">
                                {userType === 'student' ? (
                                    <>
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-3 border-b pb-2">Parent/Guardian Contact</h3>
                                            ...
                                            <div>
                                                ...
                                                {formData.noChildEmail ? (
                                                    <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600">
                                                        <span className="font-semibold text-gray-800">No email needed.</span> We will generate a username for your child to log in (e.g., <strong>firstname.lastname</strong>). You will see it after registration.
                                                    </div>
                                                ) : (
                                                    <input
                                                        type="email"
